...
function HeroSection() {
    return (
        ...
        font-bold bg-clip-text text-transparent bg-gradient-to-b from-[#FAFAFA] to-[#9CA3AF]'>
                    Master the art of music
                </h1>
                <p className='mt-4 font-normal text-base md:text-lg text-[#D1D5DB] max-w-lg mx-auto'>
